...
public class CustomAdapterMainActivity  extends ArrayAdapter<DataModelMainActivity> implements View.OnClickListener {
    ...
    public CustomAdapterMainActivity(List<DataModelMainActivity> dataSet, Context context) {
